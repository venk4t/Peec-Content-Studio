...
> **Grammarly for GEO** — a writing companion that tells human authors *which phrases to use* so their text gets cited by ChatGPT, Perplexity, Gemini and other AI engines. Generative Engine Optimization at the phrase level.
...
PEEC_MCP_TOKEN=          # just your Peec api token
```
...
Open <http://localhost:3000>. You'll be redirected to `/setup` to pick a Peec project. Selecting one:
